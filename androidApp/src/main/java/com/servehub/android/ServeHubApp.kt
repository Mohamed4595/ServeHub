...
import com.servehub.shared.LoginIntent
import com.servehub.shared.RootComponent

@Composable
fun ServeHubApp(rootComponent: RootComponent) {
        ...
        Surface(
            ...
            when (val currentScreen = screen) {
                ...
                AppScreen.Login -> LoginScreen(
                    ...
                    onPasswordChange = { rootComponent.loginStore.dispatch(LoginIntent.UpdatePassword(it)) },
